...
def call_gemini_stream(messages: List[Dict[str, str]], custom_options: Optional[Dict] = None, model_override: Optional[str] = None):
    ...
    Forwards model_override for per-request model selection + fallback.
    """
    response = call_gemini(messages, custom_options=custom_options, model_override=model_override)
